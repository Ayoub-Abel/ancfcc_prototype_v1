...
const createSliderCaptcha = () => {
    ...
    document.addEventListener('mousemove', (event) => {
        ...
        const maxMove = sliderTrack.offsetWidth - sliderThumb.offsetWidth;
        if (moveX >= 0 && moveX <= maxMove) {
            sliderThumb.style.left = `${moveX}px`;
            sliderTrack.style.width = `${moveX + sliderThumb.offsetWidth}px`;
        }
    });
